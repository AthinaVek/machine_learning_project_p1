...
clean:
	rm -f lsh cube help_functions calculations calculations_lsh calculations_cube lsh.o cube.o help_functions.o calculations.o calculations_lsh.o calculations_cube.o
